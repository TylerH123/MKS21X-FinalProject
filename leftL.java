public class leftL implements fourBlock{
  block a,b,c,d;
  /**constructor
  ...
  **/
  public leftL(int maxHeight, int midWidth){
  ...
  //makes all the blocks in the L piece move right
  ...
  //makes all the blocks in the L piece move left
  ...
  //makes all the blocks in the L piece move down
  public void descend(){
    a.moveDown();
    b.moveDown();
    c.moveDown();
