public class sBlock implements fourBlock{
  ...
  /**constructor
    ...
    *creates the S-block piece using 4 blocks placed accordingly
  **/
  public sBlock(int maxHeight, int midWidth){
  ...
  //makes all the blocks in the S-block piece move right
  ...
  //makes all the blocks in the S-block piece move left
  ...
  //makes all the blocks in the S-block piece move down
  public void descend(){
    a.moveDown();
    b.moveDown();
    c.moveDown();
